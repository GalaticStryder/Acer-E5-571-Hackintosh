 ...
 *
 * Disassembly of SSDT6.aml, Sat Jan  2 13:22:47 2016
 *
 ...
 */
DefinitionBlock ("SSDT6.aml", "SSDT", 2, "ACRSYS", "ACRPRDCT", 0x00003000)
{
    /*
                    ...
                    Else
                    {
                        If (LEqual (_T_0, 0x05))
                        {
                            ...
                            Else
                            {
                                ...
                                Else
                                {
                                    If (LEqual (CDDS (0x80007334), 0x1F))
                                    {
                                        WPCH (One, Zero)
                                    }
                                }
                        ...
                        Else
                        {
                            If (LEqual (_T_0, 0x07))
                            {
                                ...
                                Else
                                {
                                    ...
                                    Else
                                    {
                                        If (LAnd (LEqual (CDDS (0x80000100), 0x1F), LEqual (CDDS (0x80007334), 0x1F)))
                                        {
                                            WPCH (0x03, Zero)
                                        }
                                        Else
